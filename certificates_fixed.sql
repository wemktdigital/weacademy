-- WE Academy - Sistema de Certificados (Versão Corrigida)
-- Migration: 20241020000012_certificates.sql
-- Esta versão evita conflitos com triggers existentes
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns 
                   ...
                   AND column_name = 'certificate_number') THEN
...
BEGIN
    ...
    IF NEW.completed_at IS NOT NULL AND OLD.completed_at IS NULL THEN
        ...
        IF NOT EXISTS (
            ...
            -- Criar notificação para o usuário (se tabela existir)
...
DROP POLICY IF EXISTS "Admins can verify certificates" ON public.certificates;
